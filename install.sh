...
sudo curl -o https://raw.githubusercontent.com/SolemnSpirit/test/master/GPFS.dialogrc --create-dirs /home/pi/RetroPie/retropiemenu/gpitools/GPFS.dialogrc > /dev/null 2>&1 | echo 75; echo "XXX"; echo "Installing GPFS"; echo "XXX" ;
